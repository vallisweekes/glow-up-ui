...
export default function Home() {
  ...
  return (
    <div className="min-h-screen p-4 sm:p-6" style={{ backgroundColor: '#030a12' }}>
      <main className="w-full max-w-6xl mx-auto">
        {/* Header Section */}
        <div className="text-center mb-6 sm:mb-8 pt-4 sm:pt-8">
          <h1 className="text-3xl sm:text-4xl font-bold mb-2" style={{ color: '#e0e7ee' }}>
            Glow Up Journey
          </h1>
          <p className="text-sm sm:text-base mb-4 sm:mb-6 px-4" style={{ color: '#8b96a5' }}>
          ...
          {!currentUser && (
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8 px-4">
              <span className="text-sm" style={{ color: '#8b96a5' }}>Select User:</span>
              <div className="flex gap-3">
                {loading ? (
                  <p style={{ color: '#8b96a5' }}>Loading users...</p>
          ...
          {currentUser && (
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8 px-4">
              <p className="text-sm sm:text-base text-center" style={{ color: '#8b96a5' }}>
                Viewing progress as <span className="font-semibold" style={{ color: '#e0e7ee' }}>{currentUser}</span>
              </p>
              <button
        ...
        {currentUser ? (
          ...
          <div className="text-center py-12">
            <p style={{ color: '#8b96a5' }}>Select a user to view progress</p>
          </div>
        )}
      </main>
    </div>
